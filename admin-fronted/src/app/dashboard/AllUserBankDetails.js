...
const headCells = [
  // { id: 'id', label: 'Id' },
  { id: "accountant", label: "Accountant Name" },
  { id: "accNo", label: "Account No." },
  { id: "instCode", label: "Instituition Code" },
  // { id: 'image', label: 'Image' },
  { id: "transCode", label: "Transition Code" },
  { id: "created_date", label: "Created Date" },
];

const AllUserBankDetails = ({ bankDetails, loading, Message }) => {
  ...
  const { TblContainer, TblHead, TblPagination, recordsAfterPagingAndSorting } =
    useTable(bankDetails, headCells, filterFn);
      ...
      fn: (items) => {
        if (target.value == "") return items;
          ...
          return items.filter((x) =>
            x.account_holder_name.toLowerCase().includes(target.value)
          );
      },
    });
  };
...
export default AllUserBankDetails;
