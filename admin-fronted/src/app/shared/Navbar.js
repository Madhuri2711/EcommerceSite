...
const Navbar = () => {
  ...
  const goToEmailSetting = () => {
    history.push("/email-settings");
  };

  const errorlogs = () => {
    history.push("/errorlogs");
  };
    ...
    <nav className="navbar default-layout-navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
      <div className="text-center navbar-brand-wrapper d-flex align-items-center justify-content-center">
        ...
        <Link className="navbar-brand brand-logo-mini" to="/">
          <img src={require("../../assets/images/logomini.png")} alt="logo" />
        </Link>
      </div>
          ...
          <li className="nav-item nav-profile">
            <Dropdown alignRight>
              ...
              <Dropdown.Menu className="navbar-dropdown">
                ...
                <Dropdown.Item onClick={goToEmailSetting}>
                  {/* <Link to="/profile-update/"> */}
                  <i className="mdi mdi-settings mr-2 text-primary"></i>
                  <Trans>Email Settings</Trans>
                  {/* </Link> */}
                </Dropdown.Item>
                <Dropdown.Item onClick={errorlogs}>
                  <i className="mdi mdi-bug mr-2 text-primary"></i>
                  {/* <BugReportIcon className={classes.icon}></BugReportIcon> */}
                  <Trans>Error Log</Trans>
                </Dropdown.Item>
              </Dropdown.Menu>
            </Dropdown>
          </li>
