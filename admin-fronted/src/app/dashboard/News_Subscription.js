...
const News_Sunscription = () => {

    const NEWS_SUBSCRIPTION_API = `${BASE_URL}news-letter`;
    ...
    const submitData = async (fields) => {
        try {
            setLoading(true);
            const response = await axios.post(NEWS_SUBSCRIPTION_API, fields);
...
export default News_Sunscription